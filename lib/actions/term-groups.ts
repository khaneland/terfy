...
import {ITermState, ITermGroup, TerfyState, TerfyDispatch, TerfyActions} from '../terfy';
import {Immutable} from 'seamless-immutable';

function requestSplit(direction: 'VERTICAL' | 'HORIZONTAL') {
  return (activeUid: string) => (dispatch: TerfyDispatch, getState: () => TerfyState): void => {
    dispatch({
...
export function resizeTermGroup(uid: string, sizes: number[]): TerfyActions {
  return {
    uid,
