...
import {TerfyState, TerfyDispatch, TermGroupProps, TermGroupOwnProps} from '../terfy';
...
const mapStateToProps = (state: TerfyState, ownProps: TermGroupOwnProps) => ({
  childGroups: ownProps.termGroup.children.map((uid) => state.termGroups.termGroups[uid])
});

const mapDispatchToProps = (dispatch: TerfyDispatch, ownProps: TermGroupOwnProps) => ({
