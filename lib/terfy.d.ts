...
export type TerfyState = ReturnType<typeof rootReducer>;
...
export type TerfyThunkDispatch = ThunkDispatch<TerfyState, undefined, TerfyActions>;
export type TerfyDispatch = ReturnType<typeof configureStore>['dispatch'];
...
import {TerfyConnectedProps} from './containers/terfy';
export type TerfyProps = TerfyConnectedProps & extensionProps;
