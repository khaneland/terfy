...
const buildFeedUrl = (canary: boolean, currentVersion: string) => {
  ...
  return `https://${updatePrefix}.terfy.is/update/${isLinux ? 'deb' : platform}/${currentVersion}`;
};
...
export default (win: BrowserWindow) => {
  ...
  const onupdate = (
    ...
    const releaseUrl = updateUrl || `https://github.com/vercel/terfy/releases/tag/${releaseName}`;
