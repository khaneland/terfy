  ...
  const submenu: MenuItemConstructorOptions[] = [
    {
      ...
      click() {
        shell.openExternal('https://terfy.is');
      }
    },
    {
      label: 'Report Issue',
...
- [ ] Your Terfy.app version is **${version}**. Please verify your using the [latest](https://github.com/vercel/terfy/releases/latest) Terfy.app version
- [ ] I have searched the [issues](https://github.com/vercel/terfy/issues) of this repo and believe that this is not a duplicate
---
...
- **Is the issue reproducible in vanilla Terfy.app?**
<!-- 👉 Replace with info if applicable, or Is Vanilla. (Vanilla means Terfy.app without any add-ons or extras. Straight out of the box.) -->
...
<details><summary><strong>.terfy.js contents</strong></summary>
...
\`\`\`
        ...
        const issueURL = `https://github.com/vercel/terfy/issues/new?body=${encodeURIComponent(body)}`;
        const copyAndSend = () => {
          clipboard.writeText(body);
          shell.openExternal(
            `https://github.com/vercel/terfy/issues/new?body=${encodeURIComponent(
